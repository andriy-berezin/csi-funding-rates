...
function App() {
  ...
  const showRows = (rates, top = false) => rates.map((element) => (
    <tr key={element.future}>
      ...
      >{element.rate}</td>
      <td><a href={"https://www.tradingview.com/chart?symbol="+ element.future.split('-')[0]+ "USDTPERP"} 
    ...
    <Container size="lg">
      <Group position="apart" mb="sm">
        <Title order={1}  sx={(theme) => ({
            ...
            })}>CSI Funding Rates (Binance)</Title>
